...
HurDefineOtherPotentialE::usage="HurDefineOtherPotentialE[rf_, pe_] accepts the additional potential energy other than gravity in Lagrangian mechanics. Example includes spring."; 
...
HurGetELEquation[gc__] := (gcs=Flatten[ List[gc] ];ngcs=Length[gcs];
  ...
  Do[ 
    temp=HurGlobalELEquation[[ Position[ HurGlobalGeneralizedCoordinates,gcs[[i]] ][[1]][[1]] ]] = D[ D[ L, D[gcs[[i]], Global`t] ], Global`t ] - D[ L , gcs[[i]] ] + D[ DE, D[gcs[[i]], Global`t] ];
